...
<script>
  export default {
    data() {
      return {
        ...
        config: {
          ...
          lazy: true,
          lazyLoad(node, resolve) {
            axios.get('https://www.fastmock.site/mock/608aaa07a7e98094a793e1821bb69935/myData/api/getNextLevel')
            .then((res) => {
    ...
    mounted() {
      // axios.get('https://www.fastmock.site/mock/608aaa07a7e98094a793e1821bb69935/myData/api/getCascaderData')
      // .then((res) => {
